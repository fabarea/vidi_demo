...
CREATE TABLE tx_quickdemo_domain_model_book (
	...
	access_codes int(11) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_quickdemo_domain_model_accesscode (
	...
	total_downloads int(11) DEFAULT '0' NOT NULL,
	used_downloads int(11) DEFAULT '0' NOT NULL,
	von_arbeitshilfen tinyint(4) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_quickdemo_domain_model_accesslog (
	...
	code varchar(255) DEFAULT '' NOT NULL,
	book varchar(255) DEFAULT '' NOT NULL,
